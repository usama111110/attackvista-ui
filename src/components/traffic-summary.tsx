    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
      <Card className={cardClassName + " animate-fade-in hover-lift"}>
        <div className="flex justify-between items-start">
          <div>
            <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Active Connections</p>
            <p className={`text-2xl font-bold mt-1 ${isDarkMode ? "text-white" : "text-gray-800"}`}>{trafficData.activeConnections}</p>
            <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"} mt-1`}>of {trafficData.totalConnections} total</p>
          </div>
      ...
      <Card className={cardClassName + " animate-fade-in hover-lift"}>
        <div className="flex justify-between items-start">
          <div>
            <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Ingress Traffic</p>
            <p className={`text-2xl font-bold mt-1 ${isDarkMode ? "text-white" : "text-gray-800"}`}>{trafficData.ingressRate} KB/s</p>
            <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"} mt-1`}>Total: {trafficData.totalIngress} GB</p>
          </div>
      ...
      <Card className={cardClassName + " animate-fade-in hover-lift"}>
        <div className="flex justify-between items-start">
          <div>
            <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Egress Traffic</p>
            <p className={`text-2xl font-bold mt-1 ${isDarkMode ? "text-white" : "text-gray-800"}`}>{trafficData.egressRate} KB/s</p>
            <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"} mt-1`}>Total: {trafficData.totalEgress} GB</p>
          </div>
