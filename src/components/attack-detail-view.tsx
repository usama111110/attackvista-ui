...
// Generate mock data based on attack type and time range
const generateMockData = (attackId: string, timeRange: string) => {
  ...
  return timeLabels.map((time, i) => {
    // Create a pattern with some randomness but peaking in the middle
...
// Generate subnet data for attack distribution
  ...
  return (
    <Card className="p-6 backdrop-blur-lg bg-gray-800/20 border border-gray-700/50">
      <div className="flex flex-col space-y-6">
        ...
        {/* Attack Distribution by Subnet and Severity */}
