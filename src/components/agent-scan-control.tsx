...
import { Scan, FileCheck, Shield, FileX, ShieldAlert } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <Card className={`p-6 ${isDarkMode ? "bg-gray-900/50 border-gray-700/50" : "bg-white/90 border-gray-200"}`}>
        ...
        <Tabs value={scanTabView} onValueChange={(v) => setScanTabView(v as 'start' | 'history')}>
          <TabsList className="mb-4">
            <TabsTrigger value="start">Start Scans</TabsTrigger>
