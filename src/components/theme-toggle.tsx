...
export function ThemeToggle() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent 
        align="end" 
        className="backdrop-blur-xl bg-white/95 dark:bg-gray-800/95 border-indigo-100 dark:border-indigo-900/30 shadow-lg rounded-xl min-w-[140px] overflow-hidden animate-fade-in"
      >
        <DropdownMenuItem 
